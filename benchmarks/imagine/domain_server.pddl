...
(:constants
  ...
  flat-screwdriver star-screwdriver - screwdriver
...
(:action lever-scara-low-confidence
 ...
 :precondition (and
                 (not (broken-component ?comp))
                 (not (broken-tool flat-screwdriver))
                 (at-side ?comp ?side)
                 (associated-affordance ?comp ?lp)
                 (associated-confidence ?lp low)
                 (current-side ?side)
 ...
 :effect (and
           ...
           (probabilistic 0.25 (broken-tool flat-screwdriver))
           (decrease (reward) 1)
         )
)
...
(:action lever-scara-medium-confidence
 ...
 :precondition (and
                 ...
                 (at-side ?comp ?side)
                 (associated-affordance ?comp ?lp)
                 (associated-confidence ?lp medium)
                 (current-side ?side)
                 (current-tool flat-screwdriver)
                 (current-mode scara)
                 (imply (not (held)) (current-mode power))
 ...
 :effect (and
           ...
           (probabilistic 0.12 (broken-tool flat-screwdriver))
           (decrease (reward) 1)
         )
)
...
(:action lever-scara-high-confidence
 ...
 :effect (and
           ...
           (probabilistic 0.05 (broken-tool flat-screwdriver))
           (decrease (reward) 1)
         )
)
...
(:action suck-away-medium-confidence
 ...
 :precondition (and
                 ...
                 (at-side ?comp ?side)
                 (associated-affordance ?comp ?sp)
                 (associated-confidence ?sp medium)
                 (current-side ?side)
                 (current-tool suction-tool)
                 (imply (not (held)) (current-mode power))
                 (forall (?comp_ - component) (not (hides-affordance ?comp_ ?sp)))
...
(:action extract-with-pliers-medium-confidence
 ...
 :precondition (and
                 ...
                 (at-side ?comp ?side)
                 (associated-affordance ?comp ?pp)
                 (associated-confidence ?pp medium)
                 (current-side ?side)
                 (current-tool pliers)
                 (forall (?comp_ - component) (not (hides-affordance ?comp_ ?pp)))
                 (forall (?comp_ - component) (not (hides-component ?comp_ ?comp)))
